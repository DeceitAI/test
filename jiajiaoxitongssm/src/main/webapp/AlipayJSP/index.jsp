...
<script language="javascript">
	...
	function GetDateNow() {
		...
		/*var testNo=$.cookie("out_trade_no");*/
		var out_trade_no=$.cookie("order_id")
		var price = $.cookie("price")
		document.getElementById("WIDout_trade_no").value =  out_trade_no;
		document.getElementById("WIDsubject").value = "请家教下单";
